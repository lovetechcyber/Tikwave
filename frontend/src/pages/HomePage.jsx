  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/blueprint-african-bg.jpg')" }}
      >
      ...
      <section className="py-16 bg-[#fff4eb] text-center">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-6">
          {[
            { title: "Mobile Wallet", desc: "Store and send funds easily.", icon: "/icons/wallet.svg" },
            { title: "Offline Support", desc: "Works even in low-connectivity zones.", icon: "/icons/offline.svg" },
            { title: "Cultural UI", desc: "Colors, language, and layout inspired by African values.", icon: "/icons/ui.svg" },
            { title: "Secure Transfers", desc: "Verified and fraud-protected payments.", icon: "/icons/secure.svg" },
            { title: "Multi-language", desc: "Swahili, Yoruba, Hausa, French, and more.", icon: "/icons/lang.svg" },
            { title: "Community Support", desc: "Built with local voice and inclusive feedback.", icon: "/icons/community.svg" },
          ].map((item, idx) => (
            <motion.div
              key={idx}
              whileHover={{ scale: 1.05 }}
